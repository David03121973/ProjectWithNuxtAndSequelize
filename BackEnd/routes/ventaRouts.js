...
/**
 * @swagger
 * /venta/getVentasByVendedor/{id}:
 *   get:
 *     tags: [Venta]
 *     summary: Obtener todas las ventas de un vendedor
 *     description: Devuelve una lista de todas las ventas en las que el usuario especificado es el vendedor.
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 */
router.get("/venta/getVentasByVendedor/:id", authenticate(), ventaController.getVentasByVendedor);

/**
 * @swagger
 * /venta/getVentasByComprador/{id}:
 *   get:
 *     tags: [Venta]
 *     summary: Obtener todas las ventas de un comprador
 *     description: Devuelve una lista de todas las ventas en las que el usuario especificado es el comprador.
 *     parameters:
 *       - in: path
 *         name: id
 *         required: true
 ...
 *         description: Usuario no encontrado.
 */
router.get("/venta/getVentasByComprador/:id", authenticate(), ventaController.getVentasByComprador);
